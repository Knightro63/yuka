...
class HideSeek extends StatefulWidget {
  const HideSeek({super.key});
  @override
  createState() => _State();
}

class _State extends State<HideSeek> {
  late three.ThreeJS threeJs;
  late final HideSeekWorld world;
            ...
            children: [
              ...
              if(threeJs.mounted)Align(
                ...
                child: Container(
                  ...
                  alignment: Alignment.center,
                  child: Text(
                    world.ui['playingTime'].floor().toString(),
                ...
                child:Container(
                  ...
                  child: Column(
                    ...
                    children: [
                        ...
                        SizedBox(height: 50),
                        Text(
                          'Congratulations! You\'ve fragged ${world.hits} enemies.',
                          style: TextStyle(fontSize: 20),
                        ),
                    ],
                  ),
  ...
  Future<void> setup() async {
    ...
    world = HideSeekWorld(threeJs);
    await world.init();

    threeJs.addAnimationEvent((dt){
      world.animate();
      if(world.playingTime <= 0){
        setState(() {
          isFinished = true;
          _stopSession();
        });
