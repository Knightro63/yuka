...
class SteeringSeek extends StatefulWidget {
  const SteeringSeek({super.key});
  @override
  createState() => _State();
}

class _State extends State<SteeringSeek> {
  late Gui panel;
  Timer? timer;
  ...
  Future<void> setup() async {
    ...
    final seekBehavior = yuka.SeekBehavior( target.position );
    ...
    timer = Timer.periodic(Duration(milliseconds: 3000),generateTarget);
	}
