...
class UIManager {
	...
	*/
	constructor( world ) {
		...
		this.endTimeHitIndication = double.infinity;

		this.damageIndicationTime = CONFIG.UI.DAMAGE_INDICATOR.TIME;
		this.endTimeDamageIndicationFront = double.infinity;
		this.endTimeDamageIndicationRight = double.infinity;
		this.endTimeDamageIndicationLeft = double.infinity;
		this.endTimeDamageIndicationBack = double.infinity;
